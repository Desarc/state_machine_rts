...
require "stm_tcp_receive_socket"
...
local function main()
	...
	local stm_ts1 = STMTcpReceiveSocket:new("stm_rs1", scheduler)
	...
	local event5 = Event:new(stm_ts1:id(), STMTcpReceiveSocket.events.CONNECT)
